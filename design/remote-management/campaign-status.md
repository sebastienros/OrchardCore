...
| Frontend search settings | In progress | Independent branch now integrates merged `8bb1ff436`; [contract and caller audit](search-settings.md). Shared admin/API editing and page-title field implemented; strict build and 12 editor/section tests pass, including permissions, tenant isolation and feature lifecycle. Frontend runtime and final package/integration checks remain. |
