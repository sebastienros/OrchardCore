...
| Common index definitions and lifecycle | In development | Independent `codex/remote-index-definitions`, integrated with merged `7e2a48e89`; [domain audit and baseline](index-definitions.md). Shared incoming-update validation and bounded discovery implemented; strict server build and ten focused regressions pass. Typed definitions, caller integration and live indexing remain. Definitions/discovery and lifecycle remain separate B07 PRs. |
