...
| Tenant feature-profile definitions | Locally verified / preparing PR | Independent `codex/remote-tenant-feature-profiles`, integrated with merged `b9361a1bb`; [contract and evidence](feature-profiles.md). Strict solution build; server 3,281 passed (one CI-only skip), CLI 295 and MCP 78. Live HTTP/Pomi/MCP and assigned-child runtime checks pass. Strict docs and Pomi skills 0.10.23 packaging pass; PR CI remains. |
