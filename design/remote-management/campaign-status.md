...
| Application credential lifecycle | In development | Independent `codex/remote-openid-credentials`, integrated with merged `3ca2febc9`; [contract](openid-credentials.md). Private one-time output is implemented; credential endpoints and integrated verification remain. |
