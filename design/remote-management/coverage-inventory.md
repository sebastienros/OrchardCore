...
| P | Partial: important operations missing, or only helper/protocol/shared coverage | 23 |
...
There are **30 features with neither dedicated management APIs nor commands**, and **23 with
