...
| Module / feature ID | OpenAPI or HTTP surface | Existing Pomi coverage | Scope, gap and next action | Plan |
| --- | --- | --- | --- | --- |
| [OpenId](../../src/OrchardCore.Modules/OrchardCore.OpenId/Manifest.cs) / `OrchardCore.OpenId.Management` | Redacted application reads and scope CRUD | `openid applications list/show`; `openid scopes` | Existing managers provide discovery; scope edits share admin/recipe persistence, preserve unedited properties and enforce permissions. Application CRUD, role/grant assignment and credential lifecycle remain B06. | B06 |
